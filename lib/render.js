...
function renderLayout(title, content, siteName = 'VoyoFilxHd') {
  return `<!DOCTYPE html>
<html lang="ro">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>${title} — Filme online Subtitrat in Română</title>
  <meta name="description" content="Filme online subtitrate în limba română, filme noi 2026, cele mai noi filme online, filme HD, filme de acțiune, comedie, horror și filme de colecție">
      ...
      <div class="flex flex-col md:flex-row gap-8 bg-[#14120f] p-6 md:p-8 rounded-xl border gold-border shadow-2xl">
        ...
        <div class="flex flex-col justify-between space-y-4 flex-grow">
          <div class="space-y-3">
            ...
            <p class="text-xs text-zinc-400 italic">${movie.tagline \vert{}\vert{} ''} •${movie.release_date ? movie.release_date.split('-')[0] : ''}</p>
    ...
    <div class="space-y-8">
      <div class="bg-[#14120f] p-6 md:p-8 rounded-xl border gold-border flex flex-col md:flex-row gap-6 items-center md:items-start shadow-xl">
        ...
        <div class="space-y-3 text-center md:text-left flex-grow">
          ...
          <p class="text-xs text-amber-400">🎂 Data nașterii: ${person.birthday \vert{}\vert{} 'Indisponibilă'} (${person.place_of_birth || ''})</p>
