...
const DOMAIN = 'https://voyofilxhd.up.railway.app'; // Sesuaikan dengan domain Railway Anda
...
app.get('/', async (req, res) => {
  try {
    ...
    res.send(renderLayout('VoyoFilxHd — Filme online Subtitrat in Română 2026', content));
  } catch (err) {
